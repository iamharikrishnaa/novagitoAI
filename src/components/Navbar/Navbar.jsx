      ...
      <div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            />
            <div className="text-3xl text-IndianRed tracking-wide">
              Novagito
            </div>
          </div>
          ...
          {toggle && (
            <motion.div
              ...
              className="fixed h-full w-96 top-0 left-0 z-20 bg-IndianRed text-white flex flex-col justify-center items-center shadow-lg gap-8 py-8"
            >
              {navLinks.map((navLink) => {
                return (
                  <MobileNavLinks
